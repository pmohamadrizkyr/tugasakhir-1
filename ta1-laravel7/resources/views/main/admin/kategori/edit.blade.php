        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col-sm-8 col-md-6">
                    <h1 class="mr-auto">Edit Kategori</h1>
                    <hr>
                    <form action="{{ url('/kategoris/'.$kategori->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_supervisor') is-invalid @enderror" id="nama_supervisor" name="nama_supervisor" value="{{ old('nama_supervisor') ?? $kategori->nama_supervisor }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('jumlah_kategori') is-invalid @enderror" id="jumlah_kategori" name="jumlah_kategori" value="{{ old('jumlah_kategori') ?? $kategori->jumlah_kategori }}">
